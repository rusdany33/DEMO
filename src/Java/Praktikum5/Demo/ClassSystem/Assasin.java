...
public class Assasin extends Hero implements CrtiticalDamage, Weaponable {
    ...
    private int attackDamageNotification;

    public Assasin(int level) {
        super(level);
        if (level > 0) {
            this.healthPoint = (int) (2000 + ((rand.nextInt(11) + rand.nextInt(11) + rand.nextInt(11)) * 100));// Min// 2000// Max// 5000
    ...
    public int getAttackDamageNotification() {
